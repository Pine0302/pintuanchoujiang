...
$condition2 = array(
	...
	'ccot.isvalid' => true,
	'ccot.status' => array(2,3,4,5,7,8),
	'wu.isvalid' => true
);
$filed2 = " ccot.user_id,ccot.user_id,ccot.is_head,ccot.paytime,wu.weixin_name,wu.name,wu.province,wu.weixin_headimgurl ";
...
<html>
	...
	<body style="background:#f8f8f8">
		...
		<div class="ct_cont">
			...
			?>
            <?php if($info['type']==6){ ?>
                <p class="p02">恭喜您，成团成功！</p>
            <?php }else{ ?>
                <p class="p02">恭喜您，拼团成功！</p>
			<?php
				} }
				if( $group_status == 1 ){
			?>
